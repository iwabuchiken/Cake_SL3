...
start chrome.exe http://localhost/Eclipse_Luna/Cake_SL3/sis
...
start firefox.exe http://localhost/Eclipse_Luna/Cake_SL3/sis
start firefox.exe http://benfranklin.chips.jp/cake_apps/Cake_SL3/sis
