...
// 		$keyword = $this->Keyword->find('first', $option);
	...
	($store_id){
		...
		**********************************/
		...
		$option = array(
				'conditions' => array('Store.local_id' => $store_id));
// 				'conditions' => array('Store.id' => $store_id));
		
		$store = $model->find('first', $option);
	...
	($genre_id){
		...
		**********************************/
		...
		$option = array(
				'conditions' => array('Genre.local_id' => $genre_id));
// 				'conditions' => array('Store.id' => $store_id));
